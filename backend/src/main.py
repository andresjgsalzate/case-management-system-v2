...
def create_app() -> FastAPI:
    ...
    # Triage routers declare their own /api/v1/... prefixes.
    from backend.src.modules.triage.router import (
        catalogs_router as triage_catalogs_router,
        router as triage_router,
    )
    app.include_router(triage_router)
    app.include_router(triage_catalogs_router)
